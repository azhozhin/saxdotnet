...
function LoadPage()
{
	...
	try { mainSection.scrollTop = scrollPos; } catch(e) {}
}
...
function Load(key)
{
	try { userDataCache.load("docSettings"); } catch (e) {}
...
function Save(key, value)
{
  ...
  try { userDataCache.save("docSettings"); } catch (e) {}
}
...
{
  var nextNode = imageItem.parentNode.parentNode.nextSibling;
  try {
